...
Smiselno je preveriti še učinkovt $E$, ki jo izračunamo kot:
\begin{equation}
E = \frac{S_N}{N},
\end{equation}
kjer je $S_N$ pohitritev in $N$ število niti. Učinkovitost je najboljša v primeru ene same niti (\textbf{XXXXX}). Rahlo slabšo a še vedno zadovoljivo učinkovitost dosežemo tudi za dve niti (\textbf{XXXXX}), pri večjem številu niti pa ta precej pade, saj smo omejeni na zgolj dve fizični jedri. Učinkovitost v odvisnosti od števila niti je vidna na grafu \ref{graf-rezultati-ucinkovitost}.
