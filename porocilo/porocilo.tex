...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.65]{graf-rezultati-4_2.png}
...
Ob koncu se izračunane dele plošče pošlje iz posameznih procesov na prvega (gospodar), ta pa podatke sprejme, organizira v celoto in nato ploščo shrani kot datoteko.
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.53]{graf-rezultati-5_2.png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.53]{graf-rezultati-5_3.png}
...
V prejšnjih poglavjih so bile opisane posamezne metode paralelizacije, to poglavje pa združuje najboljše dosežene rezultate. Graf na sliki \ref{graf-rezultati-pregled-6} prikazuje čas izvajanja sekvenčnega algoritma ter najboljše dosežene čase izvajanja s posameznimi pristopi paralelizacije.

\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.65]{graf-rezultati-6-pregled.png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.65]{graf-rezultati-6_1-pregled.png}
...
Tekom semestra sva na primeru problema temperaturne plošče spoznala 4 različne pristope k paralelizaciji algoritma. Pri tem sva spoznala prednosti in slabosti posameznih pristopov ter dobila občutek, kdaj uporabiti katerega izmed pristopov.

Med raziskovanjem sva spoznala pomembnost merjenja rezultatov pri optimizaciji algoritma. Meritve so nama tako na primer omogočile, da sva kar se da optimalno nastavila velikost skupine pri paralelizaciji z OpenCL in tako dosegla veliko večje pohitritve kot bi jih sicer.

Večina meritev, predstavljenih v poročilu, je bila narejenih na lokalnem testnem sistemu, pri enem pristopu k paralelizaciji (z OpenMPI) pa sva se spoznala tudi z omrežjem grid in tam opravila meritve. Ugotovila sva, da je omrežje zelo uporabno za velike količine računanja, vendar se na neki točki pokaže velika latenca omrežja, s katero se moramo nekako spopasti.
