...
\textbf{TODO}: 
\begin{itemize}
\item ni treba za vsako dimenzijo tok natančno
\item omenit je treba, da se za večje plošče začne kazat razlika in da OpenCL potolče vse ostale pristope pri čisto vsaki velikosti plošče
\item mogoče za konec še omeniva, če se potem splača grafične kar za vsako paralelizacijo uporabit? (verjetno ne, so najbrž kakšni problemi, kjer pa grafična ne pride do izraza)
...
\textbf{TODO}: komentar na pohitritve
